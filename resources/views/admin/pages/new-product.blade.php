        ...
        <form action="{{route('save-product')}}" method="post" enctype="multipart/form-data">
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" required class="form-control" id="titleInput" name="title">
                </div>
                <div class="mb-3">
                    <label for="productCode" class="form-label">Product Code</label>
                    <input type="text" required class="form-control" id="productCode" name="productCode">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="imageForm" class="form-label">Product Picture</label>
                    <input class="form-control" required type="file" id="imageForm" name="imageForm">
                </div>
                <div class="mb-3">
                    <div class="mb-3">
